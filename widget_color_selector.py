...
class ColorSelectorWidget(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # self.ui.le_hue.textEdited.connect(self.rgbChanged)
        # self.ui.le_saturation.textEdited.connect(self.rgbChanged)
        # self.ui.le_value.textEdited.connect(self.rgbChanged)
        ...
        self.ui.btn_cancel.clicked.connect(self.btn_cancel)
    ...
    def rgbChanged(self):
        ...
        self._set_hsv_selector(self.color)
    ...
    def _set_hsv(self, c):
        self.ui.le_hue.setText(str(self.i(c[0])))
        self.ui.le_saturation.setText(str(self.i(c[1])))
        self.ui.le_value.setText(str(self.i(c[2])))
